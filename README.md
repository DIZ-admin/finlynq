...
Open-source personal finance with a first-party MCP server (83 HTTP / 93 stdio tools) so Claude, ChatGPT, Cursor, etc. can query and manage your finances.
...
First-party Model Context Protocol server with 83 HTTP / 93 stdio tools covering accounts, transactions, budgets, goals, loans, portfolio, subscriptions, FX rates, rules, splits, bulk edits, and file imports.
